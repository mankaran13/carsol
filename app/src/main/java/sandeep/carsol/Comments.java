...
public class Comments extends AppCompatActivity {
    ...
    public void send_comment(View view) {
        ...
        try {
            job.put("course_id" , getIntent().getStringExtra("course_id"));
        ...
        JsonObjectRequest jobreq = new JsonObjectRequest("http://"+Internet.ip+"/carsol/add_comment.php", job, new Response.Listener<JSONObject>() {
            @Override
        ...
        AppController app = new AppController(Comments.this);
...

    {
        ...
        JsonObjectRequest jobreq = new JsonObjectRequest("http://"+Internet.ip+"/carsol/get_comment.php", job, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {

...
public class Uni_list extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.uni_list_layout , container , false);
    ...
    public void get_data()
    {
        ...
        JsonObjectRequest jobreq = new JsonObjectRequest("http://"+Internet.ip+"/get_uni.php", new JSONObject(), new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    uni_adapter ad = new uni_adapter(jarr , getActivity());
